...
<div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <form id="loginForm" modelAttribute="login" action="loginProcess" method="post">
      <input type="text" name="username" placeholder="Nombre Usuario" class="fadeIn second" required>
      <input type="password" class="fadeIn third" name="password" placeholder="Constraseña" required>
